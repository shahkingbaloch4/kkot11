...
#AUTHOR : Fara,-Hacker
#OPEN SOURCE :)
#DON'T FORGET TO GIVE CREDIT TO ARADIN KING
...
def main():
	...
	print("\033[96;1m  [F] MY FACEBOOK \033[92;1m\033[91;1m")
	print("\033[92;1m  [W] MY WHATSAPP NO 03175889358\x1b[0m")
...
def log_sel():
	...
	if sel == "":
		...
		subprocess.check_output(["am", "start", "https://www.facebook.com/shahdinobaloch15"])
		main()
	elif sel =="3" or sel =="03":
		import os
		try:
			os.system("git clone https://github.com/AKING110/Pro")
			os.system("rm -rf Pro")
			...
			print("\033[91;1m\n YOUR DEVICE IS NOT SUPPORTED!\n")
	        	main()
	elif sel =="4" or sel =="04" or sel =="F" or sel =="f":
		subprocess.check_output(["am", "start", "https://www.facebook.com/babar.tunio.71"])
		main()
...
def menu():
    ...
    logo()
    print("")
    print("\033[93;1 B WELCOME : \033[92;1m"+xn)
    print("\033[93;1m  COUNTRY : \033[92;1m") + loc
...
def crack_select1():
	...
	if select =="1":
		...
		print("")
		try:
			id_limit = int(raw_input("\033[93;1m  ENTER LIMIT (\033[91;1m MAX [5]\033[93;1m): \033[92;1m"))
			print("")
		except:id_limit=1
	...
	print("\033[92;1m  USE (Flight Mod) AIRPLANE MOD\x1b[0m")
...
def crack():
	...
	print("\033[94;1m  [1] CRACK PUBLIC ID")
	print("\033[93;1m  [2] CRACK FOLLOWERS")
	print("\033[92;1m  [3] CRACK FILE [USE AUTO PASS]")
	print("")
	crack_select()
